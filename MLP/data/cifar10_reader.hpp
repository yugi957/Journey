...
void read_test(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_test("MLP/data/cifar-10/cifar-10-batches-bin", limit, images, labels, func);
}
...
void read_training(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_training("MLP/data/cifar-10/cifar-10-batches-bin", limit, images, labels, func);
}
