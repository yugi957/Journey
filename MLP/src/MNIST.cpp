...
void getMNIST(vector<vector<float>>* train_imgs, vector<vector<float>>* train_lbls, vector<vector<float>>* test_imgs, vector<vector<float>>* test_lbls) {
    system("cd");
    ifstream train_images("MLP/data/MNIST/train-images.idx3-ubyte", ios::binary);
    ifstream train_labels("MLP/data/MNIST/train-labels.idx1-ubyte", ios::binary);
    ...
    ifstream test_images("MLP/data/MNIST/t10k-images.idx3-ubyte", ios::binary);
    ifstream test_labels("MLP/data/MNIST/t10k-labels.idx1-ubyte", ios::binary);
...
void getFashionMNIST(vector<vector<float>>* train_imgs, vector<vector<float>>* train_lbls, vector<vector<float>>* test_imgs, vector<vector<float>>* test_lbls) {
    system("cd");
    ifstream train_images("MLP/data/FashionMNIST/train-images-idx3-ubyte", ios::binary);
    ifstream train_labels("MLP/data/FashionMNIST/train-labels-idx1-ubyte", ios::binary);
    ...
    ifstream test_images("MLP/data/FashionMNIST/t10k-images-idx3-ubyte", ios::binary);
    ifstream test_labels("MLP/data/FashionMNIST/t10k-labels-idx1-ubyte", ios::binary);
